...
// Make sure this JSON file exists

import styles from "./Skills.module.css";
// if you already use this helper for images

import { Code, Server, Wrench, Zap, Layers, Rocket } from 'lucide-react';
    ...
    <div className={styles.skillsHeader}>
      ...
      <div className={styles.skillsGrid}>
        {skills.map((skill, index) => (
          <div
            key={index}
            className={`${styles.skillCard} ${activeSkill === index ? styles.active : ''}`}
      ...
      <div className={styles.additionalSkills}>
        <h4 className={styles.additionalTitle}>Also Experienced With</h4>
        <div className={styles.tagsContainer}>
          {["TypeScript", "Tailwind CSS", "Redux", "MongoDB", "Vite", "REST APIs", "Responsive Design", "Figma"].map((tech, index) => (
